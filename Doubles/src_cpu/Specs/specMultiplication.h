...
template<>
inline void baileyMul_fast<4,2,5>(double const *x, double const *y, double *z){
	double p, e, f[6];
	f[5] = 0.0;
	f[4] = two_prod(x[3], y[1], e);
	f[5] = FPadd_rn(f[5], e);
	f[3] = two_prod(x[3], y[0], e);
	f[4] = two_sum(f[4], e, e);
	f[5] = FPadd_rn(f[5], e);
...
template<>
inline void baileyMul_fast<6,5,4>(double const *x, double const *y, double *z){
	double p, e, f[5];
	f[4] = FPmul_rn(x[0], y[4]);
	#if defined __CUDA_ARCH__ || FP_FAST_FMA
		f[4] = FPfma_rn(x[1], y[3], f[4]);
		f[4] = FPfma_rn(x[2], y[2], f[4]);
		f[4] = FPfma_rn(x[3], y[1], f[4]);
		f[4] = FPfma_rn(x[4], y[0], f[4]);
	#else
		f[4] = FPadd_rn(f[4], FPmul_rn(x[1], y[3]));
		f[4] = FPadd_rn(f[4], FPmul_rn(x[2], y[2]));
		f[4] = FPadd_rn(f[4], FPmul_rn(x[3], y[1]));
		f[4] = FPadd_rn(f[4], FPmul_rn(x[4], y[0]));
	#endif
	f[3] = two_prod(x[0], y[3], e);
	f[4] = FPadd_rn(f[4], e);
	p = two_prod(x[1], y[2], e);
